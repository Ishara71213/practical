import '../styles/OfferImgCard.css';
 ...
 return(
    <div className='imgCard-container'>
        ...
        <div className='priceAndbtn'>
            <p className='offer-price text-regular'>From <span className='text-medium'>{props.offerPrice}</span> Average Per Night</p>
            <a className    ="link-btn text-medium" href={props.btnUrl}>View Details</a>
        </div>
    </div>
 )
}